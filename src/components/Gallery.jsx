  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/pageja/image/upload/v1758760777/ChatGPT_Image_Sep_24_2025_09_21_27_PM_ub7p6q.png')",
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col items-center  ">
        <div className="relative w-full flex items-center justify-center">
          ...
          <div className="relative w-full flex items-center justify-center sm:mt-32 md:mt-64">
